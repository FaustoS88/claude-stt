...
echo "▶ Installing Python dependencies (pynput for PTT mode)..."
pip3 install pynput --quiet && echo "  pynput ✓" || echo "  Warning: pynput install failed — PTT mode unavailable"
...
echo "  1. macOS one-time setup:"
echo "       System Settings → Privacy & Security → Accessibility → add your terminal"
echo "       System Settings → Privacy & Security → Input Monitoring → add your terminal"
echo "  2. Open a second terminal and run:"
echo "       python3 $MCP_TARGET/ptt.py"
echo "  3. Hold ⌥ (Right Option) to record, release to transcribe. Repeat as needed."
echo "  4. In Claude Code, say: 'read my dictation'"
echo ""
